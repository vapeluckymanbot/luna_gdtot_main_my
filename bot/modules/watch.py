...
def _watch(bot: Bot, update, isTar=False, isZip=False, isLeech=False):
    ...
    try:
        ...
        msg += f"\n\nExample:\n<code>/{BotCommands.WatchCommand} https://youtu.be/CPuvm126KPA 720 |luna-mirror-bot</code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>luna-mirror-bot</b>"
